...
const videodescriptions = [
  ...
  "The fat and the furious tells the story of aggravation solved with a streetrace in an off-location in Jönköping.",
  "Promotion done for the fictional cafè 'Kafè Brädan' which was formed for a university project. A style guide was also created which can be found under the 'Graphics' category, this video was made as an extra element to this brand. The footage for this was not captured by me, although everything else like logo, animation and editing is.",
  "444",
  "555",
  "677",
];
